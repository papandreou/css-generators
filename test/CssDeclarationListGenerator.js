...
describe('CssDeclarationListGenerator', () => {
  ...
  it('should generate a CSS declaration list', () => {
    expect(new CssDeclarationListGenerator().take(10)).toEqualSnapshot([
      ...
      'border-image-outset: -8636381890871296; background-blend-mode: exclusion; transform: none; border-inline-start-color: #9c954d;',
      'align-content: baseline; max-height: min-content; backface-visibility: visible;',
      ...
      'border-bottom-right-radius: -931.223cm 26%; border-inline-start-color: hsl(-630.2911deg , 85% , 45% , 60%); padding-inline-start: 140.888em; list-style: none;',
